...
public class BSTMaya {
    public static void main(String[] args) {
        ...
        if(gudar.find(new Maya("Hanuahpu"))){
        ...
        System.out.println("Min är: " + gudar.min().getNamn());
        System.out.println("Max är: " + gudar.max().getNamn());
    }
